...
export const packages: Package[] = [
  {
    ...
    includes: ["4–6 hours of shooting", "100+ edited photos", "Highlights and Reels", "Online gallery", "10 premium prints"],
    price: "₹40,000",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    includes: ["5-6 hours shooting", "1 location", "75+ edited photos", "Online gallery", "5 premium prints"],
    price: "₹30,000",
  },
];

export const testimonials: Testimonial[] = [
  { id: "1", name: "Nibedita & Rohit", text: "Rudra captured our wedding so beautifully. Every photo tells a story — we couldn't have asked for a better photographer. The attention to detail was extraordinary.", event: "Wedding, Berhampur", category: "Wedding", rating: 5 },
  { id: "2", name: "Preeti Sahu", text: "The pre-wedding shoot was magical. Rudra made us feel so comfortable and the results were beyond our expectations. Truly an artist.", event: "Pre-Wedding, Bhubaneswar", category: "Pre-Wedding", rating: 4.5 },
  { id: "3", name: "Shruti & Vikash", text: "Professional, creative, and incredibly talented. Our wedding album is something we'll cherish forever. Thank you for making our day unforgettable.", event: "Wedding, Berhampur", category: "Wedding", rating: 5 },
  { id: "4", name: "Rashmita Achary", text: "Our engagement photos are literally perfect! Rudra's ability to capture genuine emotions is unmatched. We got so many compliments from friends and family.", event: "Engagement, Berhampur", category: "Engagement", rating: 4 },
  { id: "5", name: "Rajesh & Swati", text: "The pre-wedding shoot in Goa was the best decision. Rudra was so professional yet made us laugh and be ourselves. The photos are straight out of a magazine!", event: "Pre-Wedding, Berhampur", category: "Pre-Wedding", rating: 5 },
  { id: "6", name: "Aisha Khan", text: "Rudra photographed my sister's birthday party and captured all the candid laughter and joy. Every shot was perfectly composed. Highly recommended!", event: "Birthday Party, Berhampur", category: "Birthday", rating: 4.5 },
  ...
  { id: "8", name: "Rupali & Ranjan", text: "Our wedding day was made even more special by Rudra's photography. He has an incredible eye for those unscripted moments that we'll treasure forever.", event: "Wedding, Berhampur", category: "Wedding", rating: 5 },
  { id: "9", name: "Neha Patro", text: "The engagement shoot was so much fun! Rudra made us feel relaxed and natural. We got the most beautiful pictures that exceeded our expectations completely.", event: "Engagement, Berhampur", category: "Engagement", rating: 4.5 },
  { id: "10", name: "Ravi & Anjali", text: "Pre-wedding coverage in Jaipur was absolutely phenomenal. Every frame tells our love story. We couldn't stop crying when we saw the final album!", event: "Pre-Wedding, Bhubaneswar", category: "Pre-Wedding", rating: 5 },
  ...
  { id: "12", name: "Trisha's Birthday Bash", text: "The birthday party photos captured all the fun and celebration in such a beautiful way. Every frame sparkles with joy. Thank you, Rudra!", event: "Birthday Celebration, Bhanjanagar", category: "Birthday", rating: 4.5 },
];
